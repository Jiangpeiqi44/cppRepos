...
void cat::raiseCat()
{
	...
	int* catHome = new int[catNum];
	cout << "Congrats! Now your cats are living happily in " << catHome << endl;
...
int main()
{
	...
	srand((int)time(0));
	cout << "Hello there!\nI'm OS1,your personal cat assistant.";
	cin.get();
	...
	do
	{
		cout << "Choose the corresponding number ahead to continue !\n"
			<< "1. Raise cat" << endl
			<< "2. Interact with her" << endl
			<< "3. Show your cats' home " << endl
			<< "4. Show your cat's information" << endl
			<< "..." << endl;
		cin >> corresNum;
		cin.get();
		if (corresNum == 1)
